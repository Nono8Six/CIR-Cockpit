...
import { clientNumberSchema } from '../entity/client.schema.ts';
import { entityDepartmentCodeSchema, optionalEntityDepartmentCodeSchema } from '../admin/department.schema.ts';
