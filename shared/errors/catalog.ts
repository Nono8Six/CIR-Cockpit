...
export const ERROR_CATALOG: Record<string, ErrorCatalogEntry> = {
  ...
  CONFIGURATOR_DB_READ_FAILED: makeEntry(
  ...
  CONFIGURATOR_DB_TIMEOUT: makeEntry(
  ...
  CONFIGURATOR_OPERATING_POINT_NOT_FOUND: makeEntry(
  ...
  CONFIGURATOR_OUTPUT_INVALID: makeEntry(
    "CONFIGURATOR_OUTPUT_INVALID",
    "Résultat technique invalide.",
    "edge",
    "error",
    "contact_support",
  ),
  CONFIGURATOR_RULESET_UNAVAILABLE: makeEntry(
    "CONFIGURATOR_RULESET_UNAVAILABLE",
    "Règles techniques indisponibles.",
    "edge",
    "error",
    "contact_support",
  ),
  CONFIGURATOR_SNAPSHOT_UNAVAILABLE: makeEntry(
  ...
  AI_PROVIDER_BILLING_REQUIRED: makeEntry(
  ...
  AI_PROVIDER_CONTRACT_INVALID: makeEntry(
  ...
  AI_TOOL_ARGUMENTS_INVALID: makeEntry(
