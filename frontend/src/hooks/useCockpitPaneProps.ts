...
export const useCockpitPaneProps = (params: UseCockpitPanePropsParams) => {
  const leftPaneProps: CockpitFormLeftPaneProps = {
    ...
    isInternalRelation: params.isInternalRelation,
    isSolicitationRelation: params.isSolicitationRelation,
    isClientRelation: params.isClientRelation,
    isProspectRelation: params.isProspectRelation,
    isSupplierRelation: params.isSupplierRelation,
