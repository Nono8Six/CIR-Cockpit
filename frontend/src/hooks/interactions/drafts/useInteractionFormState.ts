...
import { useAgencies } from '../../admin/agencies/core/useAgencies';
import { useEntityContacts } from '../../entities/contacts/useEntityContacts';
import { getDefaultStatusId, type InteractionFormStateInput } from './use-interaction-form-state.types';
...
export const useInteractionFormState = ({ control, config, activeAgencyId, entitySearchIndex, selectedEntity, selectedContact }: InteractionFormStateInput) => {
  ...
  const isSolicitationRelation = relationMode === 'solicitation';
