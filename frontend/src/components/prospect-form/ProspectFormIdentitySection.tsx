...
const ProspectFormIdentitySection = ({
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
    <div>
      <label className="text-xs font-medium text-muted-foreground" htmlFor="prospect-name">Nom de la societe</label>
    ...
    <div>
      <label className="text-xs font-medium text-muted-foreground" htmlFor="prospect-city">Ville</label>
