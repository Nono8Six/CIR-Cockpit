...
const InteractionSearchContainer = ({ onOpen, onClose, children }: InteractionSearchContainerProps) => (
  <div
    data-search-unique
    className="relative min-w-0 rounded-lg border border-border bg-card shadow-sm transition-[border-color,box-shadow] focus-within:border-ring/40 focus-within:ring-2 focus-within:ring-ring/20"
