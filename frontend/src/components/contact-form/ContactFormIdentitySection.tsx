...
const ContactFormIdentitySection = ({
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
    <div>
      <label className="text-xs font-medium text-muted-foreground" htmlFor="contact-first-name">Prénom</label>
      <Input {...firstNameField} id="contact-first-name" placeholder="Prénom" autoComplete="given-name" />
      {errors.first_name && (
