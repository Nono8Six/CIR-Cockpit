...
| --- | --- | --- | --- |
| **Identification de bride** | Bride présente, hésitation ou construction non fondée | Avec ou sans pattes, grande ou petite forme — les trous traversants ou taraudés servant à départager ces deux formes, non à poser une question distincte —, puis les mesures discriminantes réellement nécessaires. *Précisé le 06/08/2026 : la nature des trous découle de la construction et n'est plus redemandée après elle.* | Retour au relevé ou au candidat avec réserve ; qualification si l'interface reste non reconnue |
| ~~**Charge radiale**~~ | ~~Courroies, chaîne ou roue sur arbre~~ | **Branche supprimée le 06/08/2026, revue PO n°3** : géométrie, poulie, diamètre, nombre de courroies, porte-à-faux et tension ne produisaient aucun calcul dans C7. La comparaison effort/limite relève du dimensionnement process, en C11. | — |
