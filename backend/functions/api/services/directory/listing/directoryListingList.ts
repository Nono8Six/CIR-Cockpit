...
import type { DirectoryListResponse } from '../../../../../../shared/schemas/system/api-responses.ts';
...
interface RawDbListRow {
  ...
  cir_commercial_name: string | null;
...
export const listDirectory = async (
  ...
  try {
    ...
    const normalizedRows = (rows as RawDbListRow[]).map((row): DirectoryListRow => ({
      ...row,
