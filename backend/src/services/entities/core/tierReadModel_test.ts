...
test('tier directory scope keeps active, other-agency and super-admin permissions explicit', () => {
...
test('canonical contact reads preserve historical ids and reject invented fields by construction', () => {
