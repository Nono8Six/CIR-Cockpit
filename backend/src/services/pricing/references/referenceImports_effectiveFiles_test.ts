...
test("reference imports expose two provided effective files", async () => {
...
test("reference imports resolve reused classification provenance", async () => {
...
test("reference imports expose no effective files for draft without file", async () => {
...
test("reference imports expose attached files for analysis error imports", async () => {
  const importId = crypto.randomUUID();
