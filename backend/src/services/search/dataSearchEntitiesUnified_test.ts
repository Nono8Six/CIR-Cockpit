...
test('matchesUnifiedEntitySearch covers V1 entity fields and normalized phone', () => {
  const row = entityRow({
    supplier_code: 'SUP1',
...
test('matchesUnifiedProfileSearch covers internal profile identity, email, agency and phone', () => {
...
test('matchesUnifiedSupplierContactSearch covers supplier contacts and labels match source', () => {
...
test('unified result mapping preserves source and V1 result type', () => {
...
test('sortUnifiedResults prioritizes exact and prefix matches before recency fallback', () => {
  const rows = [
...
test('resolveUnifiedSearchAgencyIds enforces agency permissions', () => {
