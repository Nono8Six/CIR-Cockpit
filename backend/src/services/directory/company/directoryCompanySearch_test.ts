...
test("executeCompanySearch ranks an acronym plus city match before broad city-name expansion", async () => {
...
test("executeCompanySearch keeps cir results compatible with the tRPC output schema", async () => {
...
test("executeCompanySearch filters by head office when requested", async () => {
...
test("executeCompanySearch expands common elec abbreviation before giving up", async () => {
...
test("fetchEnterpriseApiSearchResponse tolerates partial official payloads before mapping", async () => {
  await withFetchStub(
    Response.json({
      results: [{
        siren: "562016774",
...
test("fetchEnterpriseApiSearchResponse maps official rate limits explicitly", async () => {
  await withFetchStub(
...
test("fetchEnterpriseApiSearchResponse maps invalid official payloads with details", async () => {
  await withFetchStub(
