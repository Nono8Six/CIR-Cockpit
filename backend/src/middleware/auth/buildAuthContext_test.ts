...
test('buildAuthContext.toUniqueAgencyIds trims and deduplicates agency ids', () => {
...
test('buildAuthContext.isProfileAccessRevoked detects archived or system profiles', () => {
  assertEquals(
