...
test('pricing reference payload contracts are strict and bounded', () => {
...
test('pricing reference list and analyze contracts reject unsupported fields', () => {
  assertEquals(
...
test('pricing reference import responses expose effective files distinctly', () => {
...
test('pricing reference summary and listAll contracts are strict', () => {
  assertEquals(
...
test('pricing reference diff contracts are strict and cache-aware', () => {
...
test('pricing reference aggregate contract normalizes directions and aliases', () => {
...
test('pricing reference classification listAll returns a real total when capped', async () => {
  const rows = [{
    id: '11111111-1111-4111-8111-111111111111',
    snapshot_id: '33333333-3333-4333-8333-333333333333',
    import_id: '22222222-2222-4222-8222-222222222222',
...
test('pricing reference anomaly export keeps complete source rows and annotates matching anomalies', () => {
...
test('pricing reference anomalies summary aggregates faceted counts', async () => {
...
test('pricing reference column mapping contracts are strict', () => {
...
test('pricing reference tRPC namespace is protected and activate requires super admin auth', async () => {
...
test('pricing reference assist mapping contracts are strict', () => {
  const scope = {
    import_id: '11111111-1111-4111-8111-111111111111',
  };
  const assistInput = {
