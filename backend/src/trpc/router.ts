...
import {
  ...
  aiSettingsSaveFeatureAssignmentInputSchema,
...
export const appRouter = router({
  ...
  ai: router({
    ...
    settings: router({
      ...
      saveFeatureAssignment: superAdminProcedure
        .input(aiSettingsSaveFeatureAssignmentInputSchema)
        .output(aiSettingsSaveFeatureAssignmentResponseSchema)
        .mutation(withSuperAdminHandler(saveAiFeatureAssignment)),
    ...
    usage: router({
      ...
      getById: superAdminProcedure
        .input(aiUsageGetByIdInputSchema)
        .output(aiUsageGetByIdResponseSchema)
        .query(withSuperAdminHandler(getAiUsageEventById)),
    }),
  }),
  directory: router({
    list: authedProcedure
